...
class PALinearModel:
    ...
    def enabled(self):
        return self.enabled and self.pressure_advance > 0.0
    def get_pa_params(self):
        return (self.pressure_advance,) if self.enabled else (0,)
    def get_status(self, eventtime):
        return {'pressure_advance': self.pressure_advance,
                'pressure_advance_enabled': self.enabled}
    def get_msg(self):
...
class PANonLinearModel:
    ...
    def enabled(self):
        return (self.enabled
                and (self.linear_advance > 0.0
                     or self.linear_offset > 0.0))
    def get_pa_params(self):
