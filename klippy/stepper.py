...
class MCU_stepper:
    def __init__(self, name, high_precision_stepcompr,
                 step_pin_params, dir_pin_params,
...
def PrinterStepper(config, units_in_radians=False):
    ...
    mcu_stepper = MCU_stepper(name, high_precision_stepcompr,
                              step_pin_params, dir_pin_params,
                              rotation_dist, steps_per_rotation,
...
class PrinterRail:
    def __init__(self, config, need_position_minmax=True,
        ...
        self.calc_position_from_coord = (self
                                         .mcu_stepper
    ...
    def get_homing_info(self):
        homing_info = collections.namedtuple('homing_info', [
            ...
            'resting_retract_speed', 'resting_retract_dist', 'positive_dir',
            'second_homing_speed'])(
            self.homing_speed, self.position_endstop,
            self.homing_retract_speed, self.homing_retract_dist,
            self.homing_resting_retract_speed, self.homing_resting_retract_dist,
