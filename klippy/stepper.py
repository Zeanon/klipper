...
class PrinterRail:
    def __init__(
        ...
        # check for ":virtual_endstop"
        # to make sure we don't detect ":z_virtual_endstop"
        endstop_is_virtual = (
    ...
    def get_homing_info(self):
        homing_info = collections.namedtuple(
            ...
            [
                ...
                "retract_speed",
                "retract_dist",
                'resting_retract_speed',
                'resting_retract_dist',
                "positive_dir",
                "second_homing_speed",
            ...
            self.homing_resting_retract_speed,
            self.homing_resting_retract_dist,
            self.homing_positive_dir,
